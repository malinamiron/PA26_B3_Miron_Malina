...
public class ClientThread extends Thread {
    ...
    private void runGameLoop() throws IOException {
        ...
        for (Questions q : server.getQuestions()) {
            out.println("\nINTREBARE: " + q.getText());
            out.println("VARIANTE: " + q.getOptions());
            ...
            if (response.equalsIgnoreCase("ranking")) {
                ...
                out.println("Reintrodu raspunsul pentru: " + q.getText());
            ...
            boolean inTime = timeTaken <= (q.getTimeLimitSeconds() * 1000);
            boolean correct = response.equals(String.valueOf(q.getCorrectIndex()));
